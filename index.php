        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-md-start text-center py-6 wow animate__animated animate__fadeInUp">
            ...
            <div class="text-center text-md-start">
              <a class="btn btn-warning me-3 btn-lg" href="login.php" role="button">Make a Donation</a>
...
$img='assets/img/'.$pat['image'];
          ...
          <div class="col-md-4 mb-4 wow animate__animated animate__fadeInUp">
            <div style="width: 300px; height: 300px; position: relative;" class="section mx-auto" role="button" onclick="location.href='login.php'">
              <img src="<?php echo $img; ?>" class="img-fluid rounded-circle border border-warning border-2 p-1" width="300" height="300" style="height: 300px; z-index: 1000; object-fit: cover;" alt="">
              <div class="w-100 h-100 position-absolute rounded-circle d-flex justify-content-center align-items-center" style="top: 0; left: 0; background-color: rgba(0, 0, 0, .5);">
                <h3 class="text-white"><?php echo $pat['name']; ?> | Donate</h3>
              </div>
            </div>
          </div>
           <?php } ?>    
    ...
    <section class="pt-5 pt-md-9" style="background-color: #c1c3ab55;" id="how-it-works">
      ...
      <div class="container">
        ...
        <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
          <a class="btn btn-warning btn-lg" href="login.php" role="button">Make a Donation</a>
        </div>
      </div><!-- end of .container-->
