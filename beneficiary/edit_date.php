...
if (isset($_POST['submit'])) {
    ...
    $date = mysqli_real_escape_string($conn, $_POST['Recievedate']);
    


     $update_query = "UPDATE `receive_appointments` SET `beneficiary_receive_date` = '$date' "
                    . " WHERE `id` = '$appointment_id'";

            mysqli_query($conn, $update_query);
           
                $message1[] = ' The date has been modified successfully';
}
?>
<!DOCTYPE html>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 text-md-start text-center py-6">
                            <h1 class="mb-4 fs-9 fw-bold">Edit   <span class="text-warning">Appointment</span></h1>
                            <?php
                            if (isset($message)) {
                            ...
                            <form method="post" enctype="multipart/form-data" >
                                 <div class="mt-3" >
                                        ...
                                        <input type="date" name="Recievedate" id="date" class="form-control border border-dark">
                                    </div>
