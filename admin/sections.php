...
<div id="layout-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h4 class="card-title">
                                        <i class="fa me-2 fa-list-ul"></i> Sections
                                    </h4>
                                    <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        if(isset($_POST['add'])){
                                          ...
                                          include('../connect.php');  
                                          $sqlPL = $con->prepare("SELECT * FROM sections WHERE name='$name'");      
                                          $sqlPL->execute();
   ...
   $image_folder = '../assets/img/'.$image;
                                                ...
                                                $sql = "INSERT INTO sections (name , image) VALUES ('$name' , '$image')";
...
move_uploaded_file($image_tmp_name, $image_folder);
                                      ...
                                      ?>    
                                        ...
                                        include('../connect.php');  
                                        $sql = $con->prepare("SELECT * FROM sections");      
                                        $sql->execute();
                                        $rows = $sql->fetchAll();

                                        foreach($rows as $pat)
                                        {
                                            $img='../assets/img/'.$pat['image'];

                                        ?>     
                                        <tr>
                                            <td><a class="text-body fw-bold"><?php echo $pat['id']; ?></a></td>
                                            <td><?php echo $pat['name']; ?></td>
                                            <td><img class="border border-primary rounded" src="<?php echo $img; ?>" width="150" height="100" style="object-fit: cover;" alt=""></td>
                                            <td>
                                                <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light"
                                                    data-bs-target="#show-data"
                                                    data-bs-toggle="modal"
                                                    data-id="<?php echo $pat['id']; ?>"
                                                    data-name="<?php echo $pat['name']; ?>"
                                                    data-image="<?php echo $pat['image']; ?>">
                                                    Show Details
                                                </button>
                                                <a href="delete_section.php?id=<?php echo $pat['id']; ?>" onclick="return confirm('Are you sure you want to continue?')" type="button" class="btn btn-danger btn-sm btn-rounded waves-effect waves-light">
                ...
                <div class="modal fade" id="show-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <img class="border border-primary rounded card-img-top" id="modalImage" src="" style="object-fit: cover;" alt="">
                            <div class="modal-body">
                                <table class="table">
                                    <tbody>
                                        <tr>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Back</button>
                                <a href="#" id="blockButton" onclick="return confirm('Are you sure you want to continue?')" type="button" class="btn btn-danger">Delete <i class="fa fa-trash"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-body">
                                    <div class="d-flex flex-column justify-content-around gap-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="image" required id="image" placeholder="Enter Section Image">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
...
<script>
    ...
    var showModal = document.getElementById('show-data');
    showModal.addEventListener('show.bs.modal', function (event) {
        ...
        document.getElementById('modalImage').src = 'data:image;base64,' + image;
        
        // Show or hide buttons based on the status
        var blockButton = document.getElementById('blockButton');

        blockButton.href = "delete_section.php?id=" + id;
    });
</script>    
