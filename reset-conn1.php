    ...
    foreach($rows as $pat)
    {
        ...
        <div class="row align-items-center">
          <div class="col-md-6 text-md-start text-center py-6">
            ...
            <form id="login-form" method="post" action="reset-conn1.php">
              ...
              <div class="mt-3">
                <label for="password">Confirm Password <span class="text-warning-darker">*</span></label>
                <input type="password" name="confirm" required id="password" class="form-control border border-dark">
              </div>
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM beneficiaries WHERE id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
	...
	$sql = "UPDATE beneficiaries SET password='$password'  WHERE id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM donors WHERE id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
	...
	$sql = "UPDATE donors SET password='$password'  WHERE id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM deliveries WHERE id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
	...
	$sql = "UPDATE deliveries SET password='$password'  WHERE id=$id";
